...
k.appendChild(l);k.setAttribute("aria-label",b);f[a]=k}else f[a].textContent=b}q?(b="",p&&(b+='<div class="user">'+v(g[a].innerHTML)+"</div>"),b+=''+v(e[a].innerHTML)+"</p>"):e[a].innerText?(b="",p&&(b+='<p class="user">'+g[a].innerText+"</p>"),b+=''+e[a].innerText+"</p>"):(b="",p&&(b+='<p class="user">'+g[a].textContent+"</p>"),b+=''+
